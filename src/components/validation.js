...
export const Signup_validation = (
  ...
  if (title === '') {
    ...
    return {
      valid: false,
      errors: username === '' ? 'Please enter your first name' : null,
    };
    ...
    return {
      valid: false,
      errors:
        lastname.length < 3 ? 'Last name must should contain 3 letters' : null,
    };
  } else if (email === '') {
    return {
      valid: false,
    ...
    return {
      valid: false,
      errors:
        months <= 0 || months > 12 ? 'Please enter the valid month' : null,
    };
  } else if (year === '') {
    return {
      valid: false,
    ...
    return {
      valid: false,
      errors:
        PhoneNumber.length < 8 ? 'Your phone must contain 8 digits' : null,
    };
    ...
    return {
      ...
      errors:
        HasSymbol === true
          ? 'Your Phone number should not contain any kind of symbols'
          : null,
    };
  } else if (password === '') {
    return {
    ...
    return {
      valid: false,
      errors:
        password.length < 9 ? 'Password must should contain 9 digits' : null,
    };
  } else if (HasNumber.test(password) == false) {
    return {
      valid: false,
      errors:
        HasNumber.test(password) == false
    ...
    return {
      valid: false,
      errors:
        HasUpperCase.test(password) == false
          ? 'Password Does not have UpperCase'
          : null,
    };
  } else if (HasSymbol.test(password) === false) {
    return {
      errors:
        HasSymbol.test(password) === false
    ...
    return {
      valid: false,
      errors:
        HasLowerCase.test(password) === false
          ? 'Password Does not have LowerCase'
          : null,
    };
    ...
    return {
      valid: false,
      errors:
        password !== userConfirmPassword ? "Password doesn't match" : null,
    };
  } else {
    return {valid: true, errors: null};
  }
...
export const Edit_validation = (
  ...
  if (title === '') {
    ...
    return {
      ...
      errors:
        PhoneNumber.length < 8
          ? 'Your Phone number must should be greater than 8'
          : null,
    };
  } else if (HasSymbol === true) {
    return {
    ...
    return {
      valid: false,
      errors:
        oldPassword !== checkPassword ? 'Your Password is incorrect' : null,
    };
  } else if (
    (newpassword === '' && checkPassword !== '') ||
    (socialFlag == true && newpassword === '')
  ) {
    return {
      valid: false,
    ...
    (newpassword.length < 9 && checkPassword !== '') ||
    (socialFlag == true && newpassword.length < 9)
  ) {
    return {
      valid: false,
      errors:
        newpassword.length < 9 ? 'Password must should contain 9 digits' : null,
    };
  } else if (newpassword.length > 9 && HasNumber.test(newpassword) == false) {
    return {
      valid: false,
      errors:
        HasNumber.test(newpassword) == false
          ? 'Password Does not have Number'
          : null,
    };
  } else if (
    newpassword.length > 9 &&
    HasUpperCase.test(newpassword) == false
  ) {
    return {
      valid: false,
      errors:
    ...
    return {
      errors:
        HasSymbol.test(newpassword) === false
          ? 'Password Does not have Special Character'
          : null,
      valid: false,
    };
    ...
    newpassword.length > 9 &&
    HasLowerCase.test(newpassword) === false
  ) {
    return {
      valid: false,
      errors:
    ...
    (userConfirmPassword === '' && checkPassword !== '') ||
    (socialFlag == true && userConfirmPassword === '')
  ) {
    return {
      valid: false,
      errors:
    ...
    (newpassword !== userConfirmPassword && checkPassword !== '') ||
    (newpassword !== userConfirmPassword && socialFlag == true)
  ) {
    return {
      valid: false,
      errors:
        newpassword !== userConfirmPassword ? "Password doesn't match" : null,
    };
  } else {
    return {valid: true, errors: null};
  }
...
export const Card_Detail_Validations = (
  PaymentOption,
  cardHoldername,
  cardtype,
  cardnumber,
  ...
  if (PaymentOption === '') {
    ...
    return {
      valid: false,
      errors:
        cardHoldername.length < 3 ? 'Name must should contain 3 letters' : null,
    };
  } else if (cardtype === '') {
    return {
      valid: false,
    ...
    return {
      valid: false,
      errors:
        cardnumber.length < minNumer
          ? 'Your card number must should be ' + minNumer
          : null,
    };
    ...
    return {
      valid: false,
      errors:
        year <= currentYear && months < currentMonth
...
export const PhoneNumber_validation = phoneNumber => {
  if (phoneNumber === '') {
    return {
      valid: false,
